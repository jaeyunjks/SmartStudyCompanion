...
enum FlashcardSessionTheme {
    ...
    static let surfaceStrong = Color(red: 0.91, green: 0.95, blue: 0.93)
    static let mutedText = Color(red: 0.37, green: 0.41, blue: 0.40)
    static let shadow = Color(red: 0.20, green: 0.36, blue: 0.28).opacity(0.10)
}
